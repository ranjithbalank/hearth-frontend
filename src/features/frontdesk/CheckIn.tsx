...
interface RoomTypeOpt { code: string; name: string; base_rate: string; available: number }
...
function WalkInForm({ onCancel, onCreated }: { onCancel: () => void; onCreated: (id: number) => void }) {
