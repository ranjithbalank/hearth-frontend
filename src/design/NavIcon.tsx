...
const P: Record<string, JSX.Element> = {
  ...
  leave: <><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M3 9h18M8 2v4M16 2v4" /><path d="M9 14.5l2 2 4-4" /></>,
  ...
  approvals: <><rect x="4" y="3" width="16" height="18" rx="2" /><path d="M8 8h8M8 12h8" /><path d="M8.5 16.5l2 2 4-4.5" /></>,
