...
interface Opts { title: string; label?: string; defaultValue?: string; placeholder?: string; password?: boolean }
        ...
        <div className="fixed inset-0 bg-ink/40 flex items-center justify-center z-[70]" onClick={() => close(null)}>
          <div className="card p-5 w-[340px]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex gap-2">
              ...
              <button className="btn-primary flex-1" onClick={() => close(value)}>OK</button>
            </div>
          </div>
        </div>
      )}
